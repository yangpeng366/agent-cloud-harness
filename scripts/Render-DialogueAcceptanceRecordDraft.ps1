...
$lines.Add('')
$lines.Add('> Prefilled draft from starter JSON. Use the embedded browser-probe evidence as supporting seam context; strict manual gates stay unchecked until a human review records the result.')
$lines.Add('')
...
$lines.Add('')
$lines.Add('> A-H seam evidence can be prefilled from the current browser-probe bundle, but strict manual Passed checkboxes must remain a human review decision. Scripted evidence alone does not close the manual release gate.')
$lines.Add('')
...
$lines.Add('')
$lines.Add('- [ ] token-level streaming is still not accepted')
$lines.Add('- [ ] full `/v1/responses` tool-call surface is still not accepted; minimal message item lifecycle has regression coverage')
$lines.Add('- [ ] final written record still needs regeneration or review whenever the starter bundle changes')
$lines.Add('')
